...
count=1
res=requests.post('https://www.4p.com.tw/EW/Services/SearchListData.asp', data=param)
...
while data and count<=5:
	...
	for item in data:
		...
		url='https://www.4p.com.tw/EW/Services/SearchFlight.asp?prodCd='+item['GrupCd']+'&sacctNo=&flightType=1'
		source='4p'
